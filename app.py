    ...
    if st.button("🚀 Send Emails / Save Drafts"):
        ...
        with st.spinner("📨 Processing emails... please wait."):
            ...
            for idx, row in df.iterrows():
                ...
                status_text.text(f"📤 Sending... {idx+1} of {total} | ✅ Sent: {sent_count} | ⚠️ Skipped: {len(skipped)} | ❌ Failed: {len(errors)}")
        ...
        st.download_button("⬇️ Download Updated CSV", csv, file_name, "text/csv", key="manual_download")
